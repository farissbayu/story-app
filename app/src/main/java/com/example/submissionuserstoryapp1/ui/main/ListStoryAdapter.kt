...
class ListStoryAdapter: PagingDataAdapter<StoryItem, ListStoryAdapter.ListStoryViewHolder>(DIFF_CALLBACK) {
    private val listStory = ArrayList<ListStoryItem>()
    private var onItemClickCallback: OnItemClickCallback? = null

//    fun setList(story: ArrayList<ListStoryItem>) {
//        val diffCallback = DiffUtilHelper(this.listStory, story)
...
//    }
    ...
    inner class ListStoryViewHolder(val binding: StoryRowBinding): RecyclerView.ViewHolder(binding.root) {
